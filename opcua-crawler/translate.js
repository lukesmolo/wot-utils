...
const accessLevelFlagToString  = require("node-opcua-data-model").accessLevelFlagToString;
...
getOPCDataType(value) {
	switch(+value) {
		...
		case 10: return { "type": "number" };
		case 11: return { "type": "number" };
		case 12: return { "type": "string" };
		case 13: return { //datetime (timestamp)
			"type": "string",
			"format": "date-time"
		};
		case 14: return { //Guid, 16 byte
			"type": "object",
			"properties": {
				"data1":{ //uint32
					"type": "number",
		...
		case 15: return { "type": "string" }; //ByteString
		case 16: return { "type": "string" }; //XmlElement
		case 17: return { //NodeId
			"type": "object",
			"properties": {
				...
				"identifier": {
					"anyOf": [ //uint32, string, guid, bytestring
						{ //uint32
							"type": "number",
							"minimum": 0,
							"maximum": 4294967295
		...
		case 22: return "ExtensionObject";
		case 23: return "DataValue";
		case 24: return { "type": "object" } //Variant
		case 25: return "DiagnosticInfo"
	}
}
...
makeTD(data) {
	try {
		for(el of data) {
			...
			let form = {};
			form.href = 'opc.tcp://'+SERVER_IP+'?ns='+ns+';'+id_type+'='+id;
